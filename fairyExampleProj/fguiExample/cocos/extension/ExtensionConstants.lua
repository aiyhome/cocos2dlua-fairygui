...
cc.KEYBOARD_RETURNTYPE_DEFAULT_EXTRACT_UI = 6
cc.KEYBOARD_RETURNTYPE_DONE_EXTRACT_UI = 7
cc.KEYBOARD_RETURNTYPE_SEND_EXTRACT_UI = 8
cc.KEYBOARD_RETURNTYPE_SEARCH_EXTRACT_UI = 9
cc.KEYBOARD_RETURNTYPE_GO_EXTRACT_UI = 10
